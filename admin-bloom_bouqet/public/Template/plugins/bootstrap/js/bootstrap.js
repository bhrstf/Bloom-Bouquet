...
(function (global, factory) {
    ...
    // Add logic to highlight the active menu card
    function highlightActiveMenu() {
        const menuCards = document.querySelectorAll(".menu-card"); // Replace with your card menu class
        const currentPath = window.location.pathname;

        menuCards.forEach((card) => {
            const link = card.querySelector("a"); // Assuming each card has a link
